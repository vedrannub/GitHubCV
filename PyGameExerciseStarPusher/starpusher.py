...
def main():
    ...
    IMAGESDICT = {'uncovered goal': pygame.image.load('RedSelector.png'),
                  ...
                  'novo drvo': pygame.image.load('Tree_Treee.jpg')} #we load the new tree in the game
    ...
    while True: # main game loop
        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                # Handle key presses
                keyPressed = True
                #here is making the numpad  keys as direction for movement
                if event.key == K_KP4:
                    playerMoveTo = LEFT
                ...
                #here we change the camera movements on arrow keys
                ...
                #here we handle the movement of the camera
                if event.key == K_LEFT:
                    cameraLeft = False
                elif event.key == K_RIGHT:
                    cameraRight = False
