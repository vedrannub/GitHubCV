...
/**
 * Retrofit omdbapi -  pesquisa o título do filme
 */
public class searchService {
    ...
    private static void setsOmdbApi() {
        if (sOmdbApi == null) {
            // Apontamento para omdb API.
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl(API_URL)
                    .addConverterFactory(GsonConverterFactory.create())
                    .build();

            // Cria uma instância da interface de API do OMDB
    ...
    public static Result performSearch(String title) throws IOException {
        ...
        // Cria uma instância de chamada para pesquisar os nomes dos filmes por título.
